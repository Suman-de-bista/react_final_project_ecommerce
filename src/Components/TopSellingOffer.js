...
const TopSellingOffer = () => {
  ...
  return (
    <div>
      {homePage && <div className="top-brands">
                                  ...
                                  <div className="snipcart-item block">
                                    <div className="snipcart-thumb">
                                      ...
                                      <span className="starRating">
                                        <ReactStars count={5} size={18} value={0} isHalf={true} activeColor="gray" />
                                      </span>
                                    </div>
                                      <h4>
                                        Rs.{value.unitPrice[0].sellingPrice}{" "}
                                        <span>
                                          Rs.{value.unitPrice[0].markedPrice}
                                        </span>
                                      </h4>
                                    </div>
                                    <div className="snipcart-details top_brand_home_details">
                                      <input
                                        ...
                                        name="submit"
                                        value="Add to cart"
                                        className="button"onClick={()=>handleAddToCart(value)}
                                      />
                                    </div>
                                  </div>
                                </figure>
